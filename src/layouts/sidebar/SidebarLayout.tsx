      ...
      <div className="p-4 bg-[#1a1a1e] rounded-xl border border-white/5 space-y-4 transition-all">
        <div className="flex items-center justify-between">
          ...
          <ToggleSwitch
            ...
            onChange={() =>
              setConfig({ ...config, showSurahHeader: !config.showSurahHeader })
            }
          />
        </div>
            ...
            <div className="space-y-2">
              ...
              <input
                ...
                onChange={(e) =>
                  setConfig({
                    ...config,
                    surahHeaderY: parseInt(e.target.value),
                  })
                }
            ...
            <div className="space-y-2">
              ...
              <input
                ...
                onChange={(e) =>
                  setConfig({
                    ...config,
                    surahHeaderSize: parseInt(e.target.value),
                  })
                }
                className="w-full accent-studio-accent h-2 bg-black/50 rounded-lg appearance-none cursor-pointer"
              />
      ...
      <div className="p-4 bg-[#1a1a1e] rounded-xl border border-white/5 space-y-4 transition-all">
        <div className="flex items-center justify-between">
          ...
          <ToggleSwitch
            ...
            onChange={() =>
              setConfig({ ...config, showBismillah: !config.showBismillah })
            }
          />
        </div>
          ...
          <div className="space-y-4 pt-2 border-t border-white/5 animate-in slide-in-from-top-2 duration-200">
            ...
            <div className="space-y-2">
              ...
              <input
                ...
                onChange={(e) =>
                  setConfig({ ...config, bismillahY: parseInt(e.target.value) })
                }
                className="w-full accent-studio-accent h-2 bg-black/50 rounded-lg appearance-none cursor-pointer"
              />
            </div>
            <div className="space-y-2">
              ...
              <input
                ...
                onChange={(e) =>
                  setConfig({
                    ...config,
                    bismillahSize: parseInt(e.target.value),
                  })
                }
                className="w-full accent-studio-accent h-2 bg-black/50 rounded-lg appearance-none cursor-pointer"
              />
