...
export default function Sidebar({
  ...
  return (
    <div
      className={`w-full ${config.aspectRatio === "16:9" ? "md:w-[340px]" : "md:w-[400px]"} flex flex-col border-l border-white/5 bg-[#121214] h-[50vh] md:h-full z-10 shadow-2xl relative transition-all duration-300 font-sans`}
    >
