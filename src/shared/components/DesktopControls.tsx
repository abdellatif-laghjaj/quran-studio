...
export default function DesktopControls() {
  ...
  return (
    <div className="fixed top-5 right-5 z-[100] flex items-center gap-3 p-2 rounded-2xl bg-black/60 backdrop-blur-xl border border-white/10 shadow-2xl transition-all hover:bg-black/80 hover:border-white/20 hover:scale-105 group">
      <button
